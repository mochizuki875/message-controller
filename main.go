...
func init() {
	...
	utilruntime.Must(messagev1.AddToScheme(scheme))
...
func main() {
	...
	// Managerの起動(Reconcilerを含む)
	// https://pkg.go.dev/sigs.k8s.io/controller-runtime/pkg/manager#Manager.Start
	// 実装 internal.go L399
	// controllerManagerに実装されてる
